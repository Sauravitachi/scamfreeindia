...
@extends('admin.layouts.app', [
    ...
    'breadcrumbs' => Breadcrumbs::render('admin.vltrading.index'),
    'filters' => true,
    'buttons' => [
        ...
        auth()->user()->can(Permission::SCAM_LEAD_CREATE)
            ? ['label' => 'Add new lead', 'icon' => 'ti ti-plus', 'url' => route('admin.vltrading.create')]
            : null,
    ],
])
...
@section('content')
    ...
    @include('admin.vltrading._edit_offcanvas')
    @include('admin.vltrading._duplicate_leads_offcanvas')
@endsection
...
@push('script')
    <script>
        ...
        const Action = {
            ...@js([
                'editUrl' => route('admin.vltrading.edit', ':id'),
                'deleteUrl' => route('admin.vltrading.destroy', ':id'),
                'transferUrl' => route('admin.vltrading.transfer', ':id'),
                'bulkDeleteUrl' => route('admin.vltrading.bulk-delete'),
                'bulkTransferUrl' => route('admin.vltrading.bulk-transfer'),
        ...
        $(document).ready(function() {
            ...
            dtTable = $('#users-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: @js(route('admin.vltrading.index')),
                    data: function(d) {
                        d = withFilterData(d);
                    }
                },
                ...
                columns: [
                    ...
                    {
                        data: 'created_at',
                        name: 'vltrading_leads.created_at',
                        render: function(data, type, row, meta) {
        ...
        function deleteLead(leadId) {
            ...
            Popup.askConfirmation({
                variant: 'danger',
                icon: 'ti ti-trash',
                message: `You are about to delete the <strong>VLTrading lead</strong>.<br>If you proceed, you won't be able to revert this.`,
                onConfirm: async function() {
        ...
        function transferLead(leadId) {
            ...
            Popup.askConfirmation({
                variant: 'success',
                icon: 'ti ti-transfer',
                message: `You are about to transfer the <strong>VLTrading lead</strong> to main list.`,
                onConfirm: async function() {
