...
@extends('admin.layouts.app', [
    ...
    'breadcrumbs' => Breadcrumbs::render('admin.lawyer.index'),
    'filters' => true,
    'buttons' => [
        ...
        auth()->user()->can(Permission::SCAM_LEAD_CREATE)
            ? ['label' => 'Add new lead', 'icon' => 'ti ti-plus', 'url' => route('admin.lawyer.create')]
            : null,
    ],
])
...
@section('content')
    ...
    @include('admin.lawyer._edit_offcanvas')
    @include('admin.lawyer._duplicate_leads_offcanvas')
@endsection
...
@push('script')
    <script>
        ...
        const Action = {
            ...@js([
                'editUrl' => route('admin.lawyer.edit', ':id'),
                'deleteUrl' => route('admin.lawyer.destroy', ':id'),
                'transferUrl' => route('admin.lawyer.transfer', ':id'),
                'bulkDeleteUrl' => route('admin.lawyer.bulk-delete'),
                'bulkTransferUrl' => route('admin.lawyer.bulk-transfer'),
        ...
        $(document).ready(function() {
            ...
            dtTable = $('#users-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: @js(route('admin.lawyer.index')),
                    data: function(d) {
                        d = withFilterData(d);
                    }
                },
        ...
        function deleteLead(leadId) {
            ...
            Popup.askConfirmation({
                variant: 'danger',
                icon: 'ti ti-trash',
                message: `You are about to delete the <strong>lawyer lead</strong>.<br>If you proceed, you won't be able to revert this.`,
                onConfirm: async function() {
        ...
        function transferLead(leadId) {
            ...
            Popup.askConfirmation({
                variant: 'success',
                icon: 'ti ti-transfer',
                message: `You are about to transfer the <strong>lawyer lead</strong> to main list.`,
                onConfirm: async function() {
