    ...
    <div class="offcanvas-body">
        <form id="scam-lead-form" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <x-admin.select name='problem_type_id' id="problem_type_id" label='Problem Type'>
        ...
        const EDIT_LEAD_MODULE = {
            ...
            register: function() {
                ...
                EDIT_LEAD_MODULE.$offcanvas.on('hide.bs.offcanvas', function () {
                    replaceUrl("{{ route('admin.lawyer.index') }}");
                });
            ...
            prepareUi: function() {
                ...
                // making ajax request
                const url = '{{ route('admin.lawyer.show', ':id') }}'.replace(':id', EDIT_LEAD_MODULE.scamLeadId);
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if(res.success) {
                            ...
                            const formActionUrl = "{{ route('admin.lawyer.update', ':id') }}".replace(':id', scamLead.id);
                            ...
                            const editUrl = "{{ route('admin.lawyer.edit', ':id') }}".replace(':id', scamLead.id);
                            replaceUrl(editUrl);
